...
export default function Home() {
  ...
  return (
    <div className="bg-black text-white font-['Montserrat',sans-serif] min-h-screen">
      <Navigation />
      ...
      <section className="pt-40 pb-16 bg-gradient-to-b from-black via-orange-900 to-black relative overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center relative z-10 px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="hero-heading text-orange-500 mb-4">
            Where Crispiness Meets Happiness
          </h1>
          <p className="text-lg md:text-xl text-gray-200 mb-4 max-w-2xl font-bold">
            Lublin's boldest street food. Urban energy. Indulgent flavors.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <a 
              href="#menu" 
              className="bg-orange-500 px-8 py-4 rounded-full font-bold text-lg hover:bg-orange-600 transition-all duration-300 transform hover:scale-105"
            >
              See Menu
            </a>
            <Link 
              href="/order" 
              className="bg-red-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-red-700 transition-all duration-300 transform hover:scale-105"
            >
              Order Now
            </Link>
            <a 
              href="#location" 
              className="bg-yellow-400 text-black px-8 py-4 rounded-full font-bold text-lg hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105"
            >
              Visit Us
            </a>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="menu-container scrollbar-hide">
              {translatedMenuItems.map((item, index) => (
                <div
                  key={index}
                  className="menu-card rounded-xl shadow-lg p-6 hover:transform hover:scale-105 transition-all duration-300 hover:shadow-orange-500/20"
                >
                  <div className="mb-4">
                    <Image 
                      src={item.img} 
                      ...
                      width={200} 
                      height={200} 
                      className="w-11/12 h-48 object-cover rounded-lg mx-auto" 
                    />
                  </div>
                  <h3 className="text-2xl font-bold text-orange-300 mb-2">{item.title}</h3>
                  <p className="text-gray-300 mb-4 text-sm">{item.desc}</p>
                  <Link 
                    href="/order" 
                    className="bg-orange-500 px-4 py-2 rounded-lg hover:bg-orange-600 transition-colors duration-200 font-semibold"
                  >
                    {t('menu.orderNow')}
                  </Link>
                </div>
        ...
        <div className="text-center px-4 sm:px-6 lg:px-8 contact-container">
          ...
          <div className="space-y-4">
            <p className="text-gray-300">
              📞 <a 
                href="tel:+48729397306" 
                className="underline hover:text-orange-400 contact-link"
              >
                +48 729 397 306
              </a>
            </p>
            <p className="text-gray-300">
              ✉️ <a 
                href="mailto:info@lavalublin.pl" 
                className="underline hover:text-orange-400 contact-link"
              >
                info@lavalublin.pl
              </a>
